...
**119 items audited — 90 built / 20 partial / 8 missing / 1 descoped**
...
a file two lanes edit. Done a third time on merging worker certifications
into the apprenticeship work: `main` carried 122/90/21/9/2 in this line and
88/21/8/1 in the table below, and the 26 per-sheet headers summed to
neither. The per-sheet headers were right. Both figures here now come from
counting the rows, and the two counts agree.)
