...
**128 items audited — 102 built / 19 partial / 6 missing / 1 descoped**

(Sheet 17 gained one row on 2026-09-11 — GPS on site capture — taking it
from 8 built to 9 and the total from 126 to 127, and another on 2026-09-12
— the printable site photo report — taking it to 10 and the total to 128.
Re-counted both times with the same rule the paragraph below insists on:
rows beneath a `## NN.` header only, which is 102 / 19 / 6 / 1 and sums to
128, and all 26 per-sheet headers still agree with their own rows.
