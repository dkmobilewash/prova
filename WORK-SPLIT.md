...
> `apps/web/lib/actions/*.ts` (one module per domain, 34 of them as of
> 2026-09-06, and growing) behind the barrel at
...
> DESIGNED TO TEACH.** Found 2026-09-02 while auditing this file, and
> re-verified against `main` on 2026-09-06 — still broken, four days and
> 188 commits later, which is itself the argument for fixing it.
>
...
> `{ value: "TRAILER", label: "Trailer" }` (`settings/page.tsx:58`). But
