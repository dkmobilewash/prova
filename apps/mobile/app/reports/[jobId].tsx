...
function makeStyles(p: Palette) {
  return StyleSheet.create({
    ...
    head: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: space.xxs },
    ...
    work: { color: p.colors.inkBody, fontSize: typography.size.md, marginTop: space.two },
    meta: { color: p.colors.inkMuted, fontSize: typography.size.sm, marginTop: space.two },
    delay: { marginTop: space.xs, paddingTop: space.xs, borderTopWidth: 1, borderTopColor: p.colors.lineRow },
    ...
    delayText: { color: p.colors.tagRoseInk, fontSize: typography.size.sm, marginTop: space.two },
