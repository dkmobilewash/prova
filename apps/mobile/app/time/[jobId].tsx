...
function makeStyles(p: Palette) {
  return StyleSheet.create({
    ...
    clockContext: { color: p.colors.inkBody, fontSize: typography.size.md, marginTop: space.xxs },
    clockJob: { color: p.colors.inkBody, fontSize: typography.size.md, marginTop: space.xxs },
    clockOtherJob: {
    ...
    clockErrorText: { color: p.colors.tagRoseInk, fontSize: typography.size.sm, marginTop: space.xs },
    clockIdle: { color: p.colors.ink, fontSize: typography.size.md, fontWeight: typography.weight.semibold },
    breakRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8, marginTop: space.xs },
    clockActions: { gap: 8, marginTop: space.xs },
    listScroll: { flex: 1 },
