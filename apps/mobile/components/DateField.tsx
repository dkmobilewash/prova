...
function makeStyles(p: Palette) {
  return StyleSheet.create({
    ...
    calendar: { borderWidth: 1, borderColor: p.colors.lineCard, borderRadius: radius.card, padding: space.xs },
    monthRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: space.xxs },
