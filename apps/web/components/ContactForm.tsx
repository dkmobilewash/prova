...
export function ContactForm() {
  ...
  return (
    <form
      ...
      className="mb-6 flex flex-col gap-3 rounded-lg border border-line-card bg-surface p-4"
    >
      <h2 className="text-sm font-semibold text-ink-label">Add a contact</h2>
