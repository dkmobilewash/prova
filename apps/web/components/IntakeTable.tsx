...
export type IntakeJob = { id: string; name: string };
    ...
    <div>
      <div className="mb-3 flex flex-wrap items-center gap-3">
        <button
          ...
          onClick={() => file(placed)}
          className="min-h-11 rounded-md bg-brand px-4 text-sm font-semibold text-white hover:bg-blue-700 disabled:opacity-50"
        >
