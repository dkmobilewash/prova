...
export const rfisWalkthrough: Walkthrough = {
  ...
  steps: [
    ...
    {
      anchor: "acc-feed",
      title: "The GC's RFIs from Autodesk Construction Cloud",
      body:
        "If your GC runs the job in ACC, their RFIs show here once the owner links the project. They are the GC's records, not part of your log.",
    },
    {
      anchor: "acc-refresh",
