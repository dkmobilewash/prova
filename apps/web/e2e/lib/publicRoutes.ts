...
export const PUBLIC_ROUTES: readonly PublicRoute[] = [
  ...
  },
  {
    ...
    // The needle is the "What it does not do yet" heading, deep in the body,
    // rather than the hero headline — a page that died after its hero would
    // otherwise still pass.
    path: "/associations/wwcca",
    label: "WWCCA member page",
    pattern: "/associations/wwcca",
    mustShow: "What it does not do yet",
  },
